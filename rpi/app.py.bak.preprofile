    ...
    <div class="dc" style="animation-delay:${i*22}ms">
      ...
      <div class="dcb">
        ...
        ${(()=>{
          ...
          return `<a class="el" href="javascript:void(0)" onclick="openNimbus('${d.ip}','${vt}')" style="background:${colors[vt]};margin-top:4px"><span>&#x260E;</span><span class="et">${labels[vt]}</span><span class="ea">&#x2197;</span></a>`;
        })()}
        </div>
      </div>
    </div>`).join("");
